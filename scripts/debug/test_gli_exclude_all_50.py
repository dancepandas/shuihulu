"""
GLI pipeline 变体：排除 YOLO 所有非 WH 类（Boat/Bridge/Structure/tree）
输出: temp_gli_exclude_all_50/
"""
...
DATA_DIR = Path("data")
OUT_DIR = Path("temp_gli_exclude_all_50")
...
def main():
    ...
    for img_path in sorted(sample):
        ...
        cv2.putText(overlay, f"GLI-exclude-all n={len(wh_cs)}", (10, 25),
